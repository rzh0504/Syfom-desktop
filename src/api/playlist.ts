 ...
 */
export function recommendPlaylist(params?: PlaylistParams) {
 ...
 * @param {number=} params.limit
 */
export function dailyRecommendPlaylist(_params?: PlaylistParams) {
...
export function playlistCatlist() {
  return Promise.resolve({ categories: [], sub: [] });
}
